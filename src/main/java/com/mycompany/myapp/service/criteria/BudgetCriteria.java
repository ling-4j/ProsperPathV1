...
/**
 * Criteria class for the {@link com.mycompany.myapp.domain.Budget} entity. This class is used
 * in {@link com.mycompany.myapp.web.rest.BudgetResource} to receive all the possible filtering options from
...
public class BudgetCriteria implements Serializable, Criteria {
    ...
    public BudgetCriteria(BudgetCriteria other) {
        ...
        this.budgetAmount = other.optionalBudgetAmount().map(BigDecimalFilter::copy).orElse(null);
    ...
    public Optional<BigDecimalFilter> optionalBudgetAmount() {
        return Optional.ofNullable(budgetAmount);
    }

    public BigDecimalFilter budgetAmount() {
        if (budgetAmount == null) {
            setBudgetAmount(new BigDecimalFilter());
        }
        return budgetAmount;
    }
    ...
    public String toString() {
        return "BudgetCriteria{" +
            ...
            optionalBudgetAmount().map(f -> "budgetAmount=" + f + ", ").orElse("") +
