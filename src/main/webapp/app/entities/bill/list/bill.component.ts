...
import { BillService, EntityArrayResponseType } from '../service/bill.service';
...
export class BillComponent implements OnInit {
  ...
  trackId = (item: IBill): number => this.billService.getBillIdentifier(item);
