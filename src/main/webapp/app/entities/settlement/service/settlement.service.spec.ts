...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../settlement.test-samples';

import { SettlementService } from './settlement.service';

const requireRestSample: ISettlement = {
