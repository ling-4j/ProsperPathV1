...
import { sampleWithRequiredData } from '../team-member.test-samples';
...
describe('TeamMember Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.teamMembers()[0]).toEqual(expect.objectContaining({ id: 11287 }));
  });

  describe('trackId', () => {
    it('should forward to teamMemberService', () => {
      const entity = { id: 11287 };
      jest.spyOn(service, 'getTeamMemberIdentifier');
      const id = comp.trackId(entity);
      expect(service.getTeamMemberIdentifier).toHaveBeenCalledWith(entity);
