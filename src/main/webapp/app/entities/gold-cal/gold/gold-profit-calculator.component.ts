...
export default class GoldProfitCalculatorComponent implements OnInit {
    ...
    constructor(private router: Router, private goldPriceService: GoldPriceService) {}
    ...
    ngOnInit(): void {
        ...
        this.goldPriceService.getGoldPrices().subscribe({
            ...
            error: (error) => {
                ...
                this.goldTypes = [
                    { stt: 1, masp: 'SJC', tensp: 'Vàng miếng SJC', giaban: 12000, giamua: 11750, createDate: '05/05/2025', createTime: 1746433920000 },
                    { stt: 2, masp: 'N24K', tensp: 'Nhẫn Trơn PNJ 999.9', giaban: 11540, giamua: 11250, createDate: '05/05/2025', createTime: 1746433920000 },
                ];
